...
<head>
    ...
    <title>  @yield('title') | بنك الدم</title>
</head>
...
<section class="header">
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">
                            <span> مرحبا بك </span> &nbsp; &nbsp;{{ optional(auth()->guard('site_client')->user())->name }}
                        </a>
                        <div class="dropdown-menu text-right" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="{{ route('front.home') }}"> <i class="fas fa-home ml-2"></i>الرئيسيه</a>
                            ...
                            <a class="dropdown-item" href="{{ route('show.contact') }}"> <i class="fas fa-phone ml-2"></i>تواصل
                                معنا</a>
                            <a class="dropdown-item" href="{{ route('client.logout') }}"> <i class="fas fa-sign-out-alt ml-2"></i> تسجيل الخروج</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="{{ route('front.home') }}"><img src="{{ asset('front/imgs') }}/logo.png" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('show.posts') }}">المقالات</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('all.donations') }}">طلبات التبرع</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('about.us') }}">من نحن</a>
                    </li>
                    <li class="nav-item cont">
                        <a class="nav-link" href="{{ route('show.contact') }}">اتصل بنا</a>
                    </li>
                    @if(auth()->guard('site_client')->check())
                        <li class="pr-3"><a class="btn bg" href="{{ route('donation.show') }}">طلب تبرع</a></li>
                    @else
                    <li class="mr-lg-auto"><a class="signin" href="{{ route('register.client') }}">انشاء حساب جديد</a></li>
                    <li class="pr-3"><a class="btn bg" href="{{ route('login.client') }}">الدخول</a></li>
                    @endif
                </ul>
            </div>
        </div>
